...
public class TimeEntryApiTest {
    ...
    private TimeEntry timeEntry = TimeEntryBuilder.builder().projectId(projectId).userId(userId).date(LocalDate.parse("2017-01-08")).hours(8).build();
    ...
    public void testUpdate() throws Exception {
        ...
        long projectId = 2L;
        long userId = 3L;
        TimeEntry updatedTimeEntry = TimeEntryBuilder.builder().projectId(projectId).userId(userId).date(LocalDate.parse("2017-01-09")).hours(9).build();
